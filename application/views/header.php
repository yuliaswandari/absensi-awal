...
?>
    ...
    <head>
        ...
        <meta name="description" content="Absensi Pegawai">
        <meta name="author" content="Absensi Pegawai">
        <!-- Favicon icon -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                   ...
                                   <!--  <a class="dropdown-item" href="javascript:void(0)"><i class="ti-wallet m-r-5 m-l-5"></i> My Balance</a>
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="<?= base_url().'index.php/login/logout'?>" onclick="return confirm('Apakah Anda yakin akan keluar?')" title='Logout'><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
                                    <!-- <div class="dropdown-divider"></div>
